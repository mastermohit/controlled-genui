...
The API route is covered by tests for method rejection, missing prompts, overlong prompts, missing-key fallback, provider errors, missing model output, invalid schema output, and repeated-request rate limiting.
